...
const arr1 = document.getElementsByClassName("option-1");
const arr2 = document.getElementsByClassName("option-2");
const arr3 = document.getElementsByClassName("option-3");
